    ...
    public partial class LogController : BaseNopController
    {
            ...
            var gridModel = new GridModel<LogModel>
            {
                Data = logItems.Select(x =>
                {
                    return new LogModel()
                    {
						...
						CreatedOn = _dateTimeHelper.ConvertToUserTime(x.CreatedOnUtc, DateTimeKind.Utc).ToString("dd.MM.yyyy HH:mm:ss.fff")
                    };
                }),
        ...
        public ActionResult View(int id)
        {
            ...
            var model = new LogModel()
            {
				...
				CreatedOn = _dateTimeHelper.ConvertToUserTime(log.CreatedOnUtc, DateTimeKind.Utc).ToString("dd.MM.yyyy HH:mm:ss.fff")
            };
