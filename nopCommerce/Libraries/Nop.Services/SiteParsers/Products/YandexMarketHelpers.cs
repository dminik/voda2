		...
		public static readonly IEnumerable<AllowFiltering> GetAllowFilteringForProductSelector = new List<AllowFiltering>()
			{
				...
				new AllowFiltering() { FilterName = "Решетка для поджаривания булочек" },
				new AllowFiltering() { FilterName = "Разрешение видео" },
				new AllowFiltering() { FilterName = "Вместимость" },
				new AllowFiltering() { FilterName = "Регулировка степени помола" },
				new AllowFiltering() { FilterName = "Блендер" },
				new AllowFiltering() { FilterName = "Насадка для взбивания" },
				new AllowFiltering() { FilterName = "Насадка для теста" },
				new AllowFiltering() { FilterName = "Дополнительные насадки" },
				new AllowFiltering() { FilterName = "Емкость чаши, л" },
				new AllowFiltering() { FilterName = "Количество скоростей" },
				new AllowFiltering() { FilterName = "Мясорубка" },
				new AllowFiltering() { FilterName = "Соковыжималка" },
				new AllowFiltering() { FilterName = "Встроенный аккумулятор" },
				new AllowFiltering() { FilterName = "Время работы без внешнего питания" },
				new AllowFiltering() { FilterName = "FM-трансмитер" },
				new AllowFiltering() { FilterName = "Отображение карты в режиме 3D" },
				new AllowFiltering() { FilterName = "Максимальный вес" },
				new AllowFiltering() { FilterName = "Точность измерения" },
				new AllowFiltering() { FilterName = "Чаша для взвешивания" },
				new AllowFiltering() { FilterName = "Измерение объема жидкости" },
				new AllowFiltering() { FilterName = "Автоотключение" },
				new AllowFiltering() { FilterName = "Количество ярусов" },
				new AllowFiltering() { FilterName = "Защита от перегрева" },
				new AllowFiltering() { FilterName = "Автоотключение" },
				new AllowFiltering() { FilterName = "Уровни мощности" },
				new AllowFiltering() { FilterName = "Давление помпы" },
				new AllowFiltering() { FilterName = "Контроль крепости кофе" },
				new AllowFiltering() { FilterName = "Противокапельная система" },
				new AllowFiltering() { FilterName = "Таймер" },
				new AllowFiltering() { FilterName = "Встроенная кофемолка" },
				new AllowFiltering() { FilterName = "Плита автоподогрева" },
				new AllowFiltering() { FilterName = "Индикация включения" },
				new AllowFiltering() { FilterName = "Фильтр" },
				new AllowFiltering() { FilterName = "Объем кофейника" },
				new AllowFiltering() { FilterName = "Регулировка температуры" },
				new AllowFiltering() { FilterName = "Дополнительные насадки" },
				new AllowFiltering() { FilterName = "Режимы мощности" },
				new AllowFiltering() { FilterName = "Ионизация" },
				new AllowFiltering() { FilterName = "Холодный воздух" },
				new AllowFiltering() { FilterName = "Материал" },
				new AllowFiltering() { FilterName = "Точность измерения" },
				new AllowFiltering() { FilterName = "Способ бритья" },
				new AllowFiltering() { FilterName = "Количество бритвенных головок" },
				new AllowFiltering() { FilterName = "Триммер" },
				new AllowFiltering() { FilterName = "Индикатор заряда аккумуляторов" },
				new AllowFiltering() { FilterName = "Автоматическое устройство для чистки" },
				new AllowFiltering() { FilterName = "Насадки" },
				new AllowFiltering() { FilterName = "Возможность встройки" },
				new AllowFiltering() { FilterName = "Внутренний объем" },
				new AllowFiltering() { FilterName = "Диаметр поворотного стола" },
				new AllowFiltering() { FilterName = "Внутреннее покрытие" },
				new AllowFiltering() { FilterName = "Пароварка" },
				new AllowFiltering() { FilterName = "Мощность" },
				new AllowFiltering() { FilterName = "Режим разморозки" },
				new AllowFiltering() { FilterName = "Тип уборки" },
				new AllowFiltering() { FilterName = "Мощность всасывания" },
				new AllowFiltering() { FilterName = "Система фильтрации" },
				new AllowFiltering() { FilterName = "Пылесборник" },
				new AllowFiltering() { FilterName = "Возможность подключения турбощётки" },
				new AllowFiltering() { FilterName = "Насадки в комплекте" },
				new AllowFiltering() { FilterName = "Регулятор мощности на корпусе" },
				new AllowFiltering() { FilterName = "Дистанционное управление мощностью на рукоятке" },
				new AllowFiltering() { FilterName = "Потребляемая мощность" },
				new AllowFiltering() { FilterName = "Аквафильтр" },
				new AllowFiltering() { FilterName = "Регулировка температуры" },
				new AllowFiltering() { FilterName = "Дополнительные насадки" },
				new AllowFiltering() { FilterName = "Тип нагревающего элемента" },
				new AllowFiltering() { FilterName = "Объем" },
				new AllowFiltering() { FilterName = "Продуктивность" },
				new AllowFiltering() { FilterName = "Насадка для колбас" },
				new AllowFiltering() { FilterName = "Измельчитель для овощей и фруктов" },
				new AllowFiltering() { FilterName = "Соковыжималка для ягод и томатов" },
				new AllowFiltering() { FilterName = "Жерновая мельница" },
				new AllowFiltering() { FilterName = "Функция реверс" },
				new AllowFiltering() { FilterName = "Импульсный режим" },
				new AllowFiltering() { FilterName = "Турборежим" },
				new AllowFiltering() { FilterName = "Емкость чаши блендера" },
				new AllowFiltering() { FilterName = "Тип автомагнитолы" },
				new AllowFiltering() { FilterName = "Поддержка стандартов носителей" },
				new AllowFiltering() { FilterName = "Эквалайзер" },
				new AllowFiltering() { FilterName = "Типоразмер" },
				new AllowFiltering() { FilterName = "Поддержка" },
				new AllowFiltering() { FilterName = "Дистанционное управление" },
				new AllowFiltering() { FilterName = "ТВ-тюнер" },
				new AllowFiltering() { FilterName = "FM-тюнер" },
				new AllowFiltering() { FilterName = "Усилитель" },
				new AllowFiltering() { FilterName = "Защита" },
				new AllowFiltering() { FilterName = "Керамические пластины" },
				new AllowFiltering() { FilterName = "Фиксация зажима" },
				new AllowFiltering() { FilterName = "Количество уровней длины" },
				new AllowFiltering() { FilterName = "Лезвия" },
				new AllowFiltering() { FilterName = "Время полной зарядки" },
				new AllowFiltering() { FilterName = "Аксессуары" },
				new AllowFiltering() { FilterName = "Диаметр динамика" },
				new AllowFiltering() { FilterName = "Мощность (номинальная)" },
				new AllowFiltering() { FilterName = "Кол-во полос" },
				new AllowFiltering() { FilterName = "Подошва" },
				new AllowFiltering() { FilterName = "Система отчистки от накипи" },
				new AllowFiltering() { FilterName = "Вертикальное отпаривание" },
				new AllowFiltering() { FilterName = "Режим сохранения хлеба горячим" },
				new AllowFiltering() { FilterName = "Регулировка веса" },
				new AllowFiltering() { FilterName = "Крюк для замешивания теста" },
				new AllowFiltering() { FilterName = "Отсрочка старта" },
				new AllowFiltering() { FilterName = "Автоматические программы, шт." },
				new AllowFiltering() { FilterName = "Соковыжималка для цитрусовых" },
				new AllowFiltering() { FilterName = "Тип загрузочного лотка" },
				new AllowFiltering() { FilterName = "Объем кувшина для сока" },
				new AllowFiltering() { FilterName = "Объем контейнера для мякоти" },
				new AllowFiltering() { FilterName = "Венчики, мешалки" },
				new AllowFiltering() { FilterName = "Кувшин" },
				new AllowFiltering() { FilterName = "Функция turbo" },
				new AllowFiltering() { FilterName = "Максимальная мощность" },
				new AllowFiltering() { FilterName = "Подставка для варки яиц" },
				new AllowFiltering() { FilterName = "Чаша для приготовления риса" },
				new AllowFiltering() { FilterName = "XXXXX" },
				new AllowFiltering() { FilterName = "XXXXX" },
				new AllowFiltering() { FilterName = "XXXXX" },
				new AllowFiltering() { FilterName = "XXXXX" },
			};
